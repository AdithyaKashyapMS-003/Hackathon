      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-24">
          <div className="bg-white p-8 rounded-2xl shadow-md border border-gray-200 transform transition-transform duration-300 hover:scale-105">
            ...
            <p className="text-sm text-gray-600">{t("com_card1_desc")}</p>
          </div>
          <div className="bg-white p-8 rounded-2xl shadow-md border border-gray-200 transform transition-transform duration-300 hover:scale-105">
            <h3 className="text-lg font-bold text-gray-800 mb-2">
              {t("com_card2_title")}
            </h3>
            <p className="text-sm text-gray-600">{t("com_card2_desc")}</p>
          </div>
          <div className="bg-white p-8 rounded-2xl shadow-md border border-gray-200 transform transition-transform duration-300 hover:scale-105">
            <h3 className="text-lg font-bold text-gray-800 mb-2">
              {t("com_card3_title")}
            </h3>
            <p className="text-sm text-gray-600">{t("com_card3_desc")}</p>
          </div>
          <div className="bg-white p-8 rounded-2xl shadow-md border border-gray-200 transform transition-transform duration-300 hover:scale-105">
            <h3 className="text-lg font-bold text-gray-800 mb-2">
              {t("com_card4_title")}
            </h3>
            <p className="text-sm text-gray-600">{t("com_card4_desc")}</p>
          </div>
        </div>

        {/* Recent Successful Farmers */}
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold text-gray-900">{t("com_title")}</h2>
